...
public class WenyiUser extends BaseModel implements Serializable {
	...
	private String _uimage30; // u_portrait
	private String _uimage50;
	private String _uimage180;
	private String _score; // u_gold
	private String _level; // u_lvlname
	private String _msgcount; // u_newmsg_count
	private String _level_core; // u_exp
	private String _login_type;
	private String _u_newfriends_count;
	...
	public WenyiUser(String _ID, String _mID, String token, String _userguid,
			String _email, String _nickname, String _password, int _flag,
			String _uimage30, String _uimage50, String _uimage180,
			String _score, String _level, String _msgcount,
			String u_newfriends_count) {
		super();
		this._ID = _ID;
		this._mID = _mID;
		this.token = token;
		...
		this._u_newfriends_count = u_newfriends_count;
	...
	public String get_u_newfriends_count() {
		return _u_newfriends_count;
	}

	public void set_u_newfriends_count(String _u_newfriends_count) {
		this._u_newfriends_count = _u_newfriends_count;
	}
