...
public class JsonObjectRequest extends JsonRequest<JSONObject> {
     ...
     *   indicates no parameters will be posted along with request.就是以POST形式向服务器发送的数据.
    ...
    public JsonObjectRequest(int method, String url, String strRequest,
            Listener<JSONObject> listener, ErrorListener errorListener) {
        super(method, url, strRequest, listener,
                    errorListener);
    }
