...
public abstract class Request<T> implements Comparable<Request<T>> {
	 ...
	 * 
	 * @deprecated Use
	 *             {@link #Request(int, String, com.shecook.wenyi.common.volley.Response.ErrorListener)}
	 *             .
	 */
	@Deprecated
	...
	public byte[] getPostBody() throws AuthFailureError {
		...
		Log.d("request", "getPostBody " + postParams);
	...
	private byte[] encodeParameters(Map<String, String> params,
		...
		Log.d("request", "encodeParameters");
	...
	/**
	 * 设置是否需要缓存该 request的 responses。</p>
	 * <P>
	 * 
	 ...
	 * 
	 * @param response
	 *            Response from the network ( 从network返回的 Response)
	 ...
	 * 
	 * @param volleyError
	 *            the error retrieved from the network(从网络中检索到的错误)
