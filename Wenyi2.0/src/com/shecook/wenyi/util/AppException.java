 ...
 * @author lixf (http://my.oschina.net/liux)
 * @version 1.0
 */
...
//			Toast.makeText(ctx, R.string.auth_error, Toast.LENGTH_SHORT).show();
	...
	public void saveErrorLog(Exception excp) {
		...
		try {
			...
			if(storageState.equals(Environment.MEDIA_MOUNTED)){
				savePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Kimiss/Log/";
	...
	private String getCrashReport(Context context, Throwable ex) {
		PackageInfo pinfo = ((MainApplication)context.getApplicationContext()).getPackageInfo();
