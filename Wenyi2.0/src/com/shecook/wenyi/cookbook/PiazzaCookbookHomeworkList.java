...
import com.shecook.wenyi.cookbook.adapter.PiazzaCookbookHomeworkListAdapter;
...
public class PiazzaCookbookHomeworkList extends BaseFragmeng implements OnClickListener{
	...
	private PiazzaCookbookHomeworkListAdapter mAdapter;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.piazza_cookbook_homework_list,
				container, false);
		initView(rootView);
...
//		ListView actualListView = mPullRefreshListView.getRefreshableView();
		...
		mAdapter = new PiazzaCookbookHomeworkListAdapter(mActivity, mListItems);
