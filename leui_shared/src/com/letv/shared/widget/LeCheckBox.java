 ...
 */
public class LeCheckBox extends CheckBox implements LeCheckable, ValueAnimator.AnimatorUpdateListener,
...
//        }
        ...
        if (a != null) {
            ...
            mBoxTrackColor = a.getColor(R.styleable.leCheckbox_leBoxTrackColor, mBoxTrackColor);
            mBoxBorderColor = a.getColor(R.styleable.leCheckbox_leBoxBorderColor, mBoxBorderColor);
...
//        clickable = a.getBoolean(android.R.styleable.View_clickable, clickable);
        a.recycle();
    ...
    public void attachAnimateToTextViewColor(TextView textView, int colorOnCheck) {
        ...
        if (mTextColorOnChecked == null) {
            mTextColorOnChecked = ColorStateList.valueOf(colorOnCheck);
        }
    ...
    public void setChecked(boolean checked, boolean playAnimation) {
        ...
        if (mCurrentAnimatior != null ) {
            mCurrentAnimatior.cancel();
            mCurrentAnimatior = null;
        } 

        if (checked && mShowAnimatior != null) {
            mShowAnimatior.start();
            mCurrentAnimatior = mShowAnimatior;
        } else if (!checked && mHiddenAnimatior != null) {
            mHiddenAnimatior.start();
            mCurrentAnimatior = mHiddenAnimatior;
        }
