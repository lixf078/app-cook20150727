...
public class LeLicenceDialog {
    /**
     * 使用协议 隐私协议 位置 联网
     * @deprecated Use {@link #TYPE_USER_PRIVACY_LOCATION_NET} instead
     * */
    public static final int TYPE_POSITION_NET = 1;
    /**
     * 使用协议 隐私协议 联网
     * @deprecated Use {@link #TYPE_USER_PRIVACY_NET} instead
     * */
    ...
    public static final String OVER_SEA_FEATURE = "com.letv.shared.widget.reference_to_oversea_libs";
    ...
    private void initDialog(String appName, int type) {
        ...
        switch (type) {
            ...
            case TYPE_USER_PRIVACY_LOCATION_NET:
                agreementStr = mContext.getString(R.string.le_licence_dialog_user_privacy);
                pemissionStr = mContext.getString(R.string.le_licence_dialog_permission_location_net);
                break;
            case TYPE_NET:
            case TYPE_USER_PRIVACY_NET:
                agreementStr = mContext.getString(R.string.le_licence_dialog_user_privacy);
                pemissionStr = mContext.getString(R.string.le_licence_dialog_permission_net);
                break;
            case TYPE_USER_LOCATION_NET:
                agreementStr = mContext.getString(R.string.le_licence_dialog_user);
                pemissionStr = mContext.getString(R.string.le_licence_dialog_permission_location_net);
                break;
            ...
            case TYPE_PRIVACY_NET:
                ...
                pemissionStr = mContext.getString(R.string.le_licence_dialog_permission_net);
                break;
            case TYPE_USER_PRIVACY_CONTACTS_LOCATION_NET:
                agreementStr = mContext.getString(R.string.le_licence_dialog_user_privacy);
                pemissionStr = mContext.getString(R.string.le_licence_dialog_permission_contacts_location_net);
                break;
        }

        // 如果是海外版本
        if (mContext.getPackageManager().hasSystemFeature(OVER_SEA_FEATURE)) {
            switch (type) {
                case TYPE_POSITION_NET:
                case TYPE_USER_PRIVACY_LOCATION_NET:
                    agreementStr = mContext.getString(R.string.le_licence_dialog_user_privacy_oversea);
                    break;
                case TYPE_NET:
                case TYPE_USER_PRIVACY_NET:
                    agreementStr = mContext.getString(R.string.le_licence_dialog_user_privacy_oversea);
                    break;
                case TYPE_USER_LOCATION_NET:
                    agreementStr = mContext.getString(R.string.le_licence_dialog_user_oversea);
                    break;
                case TYPE_PRIVACY_LOCATION_NET:
                    agreementStr = mContext.getString(R.string.le_licence_dialog_privacy_oversea);
                    break;
                case TYPE_USER_NET:
                    agreementStr = mContext.getString(R.string.le_licence_dialog_user_oversea);
                    break;
        ...
        // en language eg. Allow %1$s to access your network information
        pemissionStr = String.format(pemissionStr, appName);
        // url link
        tvLicenceContent.setText(Html.fromHtml(
                String.format(mContext.getString(R.string.le_licence_dialog_content),
                        appName, agreementStr, pemissionStr)
        ));
