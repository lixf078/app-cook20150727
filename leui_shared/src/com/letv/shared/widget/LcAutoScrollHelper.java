 ...
 * {@link com.letv.shared.widget.LcAutoScrollHelper.AbsListViewAutoScroller} for an {@link android.widget.AbsListView}
 ...
 * {@link android.view.ViewConfiguration#getTapTimeout()} to avoid conflicting with taps.
 ...
 * </ul>
 */
public abstract class LcAutoScrollHelper implements View.OnTouchListener {
    /**
     ...
     */
    public LcAutoScrollHelper(View target) {
        mTarget = target;
     ...
     */
    public LcAutoScrollHelper setEnabled(boolean enabled) {
        if (mEnabled && !enabled) {
            requestStop();
        }
     ...
     * @return The scroll helper, which may used to chain setter calls.
     */
    public LcAutoScrollHelper setExclusive(boolean exclusive) {
     ...
     * @return The scroll helper, which may used to chain setter calls.
     */
    public LcAutoScrollHelper setMaximumVelocity(float horizontalMax, float verticalMax) {
     ...
     * @return The scroll helper, which may used to chain setter calls.
     */
    public LcAutoScrollHelper setMinimumVelocity(float horizontalMin, float verticalMin) {
     ...
     * @return The scroll helper, which may used to chain setter calls.
     */
    public LcAutoScrollHelper setRelativeVelocity(float horizontal, float vertical) {
     ...
     * @return The scroll helper, which may used to chain setter calls.
     */
    public LcAutoScrollHelper setEdgeType(int type) {
        mEdgeType = type;
        return this;
    }
     ...
     * @return The scroll helper, which may used to chain setter calls.
     */
    public LcAutoScrollHelper setRelativeEdges(float horizontal, float vertical) {
     ...
     * @return The scroll helper, which may used to chain setter calls.
     */
    public LcAutoScrollHelper setMaximumEdges(float horizontalMax, float verticalMax) {
     ...
     * {@link android.view.ViewConfiguration#getTapTimeout()}.
     * <p>
     ...
     * @return The scroll helper, which may used to chain setter calls.
     */
    public LcAutoScrollHelper setActivationDelay(int delayMillis) {
     ...
     * @return The scroll helper, which may used to chain setter calls.
     */
    public LcAutoScrollHelper setRampUpDuration(int durationMillis) {
     ...
     * @return The scroll helper, which may used to chain setter calls.
     */
    public LcAutoScrollHelper setRampDownDuration(int durationMillis) {
    ...
    /**
     * Sends a {@link android.view.MotionEvent#ACTION_CANCEL} event to the target view,
    ...
    /**
     * Scroller whose velocity follows the curve of an {@link android.view.animation.Interpolator} and
    ...
    /**
     * An implementation of {@link com.letv.shared.widget.LcAutoScrollHelper} that knows how to scroll
     * through an {@link android.widget.AbsListView}.
     */
    public static class AbsListViewAutoScroller extends LcAutoScrollHelper {
