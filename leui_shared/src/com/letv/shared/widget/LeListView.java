...
public class LeListView extends ListView implements SwipeListViewHelper.Callback{
    ...
    public View getFrontView(int position) {
        ...
        Log.e(TAG, "getFrontView position " + position + ",numHeaders " + ",countOfAll " + countOfAll);
        ...
        if (position < countOfAll - numFooters) {
            ...
            Log.e(TAG, "getFrontView childView " + childView + ",mSwipeFrontView id " + mSwipeFrontView + ",mSwipeFrontView " +  childView.findViewById(mSwipeFrontView));
