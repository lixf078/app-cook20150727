...
public class LeTopWidgetArc extends LinearLayout {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams((int) mTabWidth / mTabWidgetBtns.size(), mTabHeight);
        if (!isAdd) {
            removeAllViews();
    ...
    public void setTabOnClickListener(int index, View.OnClickListener listener) {
    ...
    public void setTabListener(int index, View.OnClickListener listener) {
