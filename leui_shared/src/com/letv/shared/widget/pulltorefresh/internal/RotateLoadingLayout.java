...
public class RotateLoadingLayout extends LoadingLayout {
    ...
    protected Matrix mHeaderImageMatrix;

    protected float mRotationPivotX, mRotationPivotY;

    protected boolean mRotateDrawableWhilePulling;

    public RotateLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
        super(context, mode, scrollDirection, attrs);

        mRotateDrawableWhilePulling = attrs.getBoolean(R.styleable.PullToRefresh_lePtrRotateDrawableWhilePulling, true);
...
//        });
    ...
    protected void resetImageRotation() {
