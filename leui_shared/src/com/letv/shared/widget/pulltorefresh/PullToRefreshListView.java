    ...
    protected ListView createRefreshableView(Context context, AttributeSet attrs) {
        if (mRefreshableViewLayout == -1) {
            ...
            if (view instanceof ListView) {
                ...
                throw new UnsupportedOperationException("Refreshable View is not a ListView");
            }
        }
    }
...
//        mListViewExtrasEnabled = a.getBoolean(R.styleable.PullToRefresh_lePtrListViewExtrasEnabled, true);
//
//        if (mListViewExtrasEnabled) {
