...
//                Log.i("zz", "onMeausre 1 " + getChildHeight(view) + "--" + preferredHeight);
...
//        Log.i("zz", "onMeasure 3 " + widthSize + "--" + heightSize);
    }
...
//                Log.i("zx", "pointToPosition frame = " + frame.toShortString() + "--" + x + "--" + y);
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link com.letv.shared.widget.AbsSpinner#onSaveInstanceState()}
         */
