...
public class DragSortGridView extends GridView {
    private static final int INVALID_ID = DragSortAbstractGridAdapter.INVALID_ID;
...
//    private boolean mWobbleInEditMode = true;
    ...
    private Stack<DragSortGridModification> mModificationStack;
    private DragSortGridModification mCurrentModification;
     ...
     */
    public void startDragSort(int position) {
...
//            stopWobble(true);
    ...
    public void setUndoSupportEnabled(boolean undoSupportEnabled) {
        if (this.mUndoSupportEnabled != undoSupportEnabled) {
            if (undoSupportEnabled) {
                this.mModificationStack = new Stack<DragSortGridModification>();
            } else {
    ...
    public void undoLastModification() {
        if (mUndoSupportEnabled) {
            if (mModificationStack != null && !mModificationStack.isEmpty()) {
                DragSortGridModification modification = mModificationStack.pop();
    ...
    private void undoModification(DragSortGridModification modification) {
    ...
    public void init(Context context) {
        ...
        mOverlapIfSwitchStraightLine = getResources().getDimensionPixelSize(R.dimen.le_dragsort_grid_overlap_if_switch_straight_line);
    }
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mUndoSupportEnabled) {
                    if (mCurrentModification != null && !mCurrentModification.getTransitions().isEmpty()) {
                        ...
                        mCurrentModification = new DragSortGridModification();
                    }
                }
    ...
    private void handleCellSwitch() {
        ...
        for (Long id : idList) {
            ...
            if (view != null) {
                ...
                if ((aboveRight(targetColumnRowPair, mobileColumnRowPair)
                    ...
                    float xDiff = Math.abs(DragSortGridUtils.getViewX(view) - DragSortGridUtils.getViewX(mMobileView));
                    float yDiff = Math.abs(DragSortGridUtils.getViewY(view) - DragSortGridUtils.getViewY(mMobileView));
        ...
        if (targetView != null) {
            ...
            final DragSortGridAdapterInterface adapter = getAdapterInterface();
    ...
    public interface OnDragListener {
        /**
         * called when view been Draging
         * 
         * @param position The postion of item which been Draging.
         **/
        public void onDragStarted(int position);

        /**
         * called when view been Draging and position been Changed
         * 
         * @param oldPosition The old postion of item which is Draging.
         * @param newPosition The new postion of item which is Draging.
         **/
...
class DragSortGridModification {

    private List<Pair<Integer, Integer>> transitions;

    DragSortGridModification() {
        super();
