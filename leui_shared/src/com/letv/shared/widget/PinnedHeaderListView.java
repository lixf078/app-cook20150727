...
public class PinnedHeaderListView extends LeListView {
    ...
    public void setOnScrollListener(OnScrollListener onScrollListener) {
        HeaderListViewOnScrollListener headerOnScrollListener = new HeaderListViewOnScrollListener(onScrollListener);
        super.setOnScrollListener(headerOnScrollListener);
    }
    ...
    private class HeaderListViewOnScrollListener implements OnScrollListener {
        ...
        public HeaderListViewOnScrollListener(OnScrollListener onScrollListener) {
