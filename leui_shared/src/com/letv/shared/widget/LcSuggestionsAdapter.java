 ...
 * @hide
 */
class LcSuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    public LcSuggestionsAdapter(Context context, int layoutId, LcSearchView searchView,
    ...
    private final static class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            mIconRefine = (ImageView) v.findViewById(R.id.lc_edit_query);
        }
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (views.mText1 != null) {
            ...
            setViewText(views.mText1, formatMatchWords(text1));
        }
    ...
    public void onClick(View v) {
        ...
        if (tag instanceof CharSequence) {
            mSearchView.onQueryRefine((CharSequence) tag.toString());
        }
    }
